      ...
      >
        ...
        <div className="pt-[10px] flex flex-col">
          ...
          <div className="mt-[2.5rem] flex ">
            <a className="text-center px-[20px] py-[9px] text-[13px] bg-gradient-to-br from-[#eff0f3] to-[#ffffff] p-4 text-[#2f2f2f] min-w-[120px] font-semibold shadow-[3px_3px_3px_#e8e6e6,-3px_-3px_3px_#fff] border border-[#116d42]">
              Price on request
            </a>
          </div>
        </div>
