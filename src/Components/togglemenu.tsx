...
export default function Togglemenu() {
    ...
    // Set the initial openIndex to mediaIndex (if found), otherwise null
    const [openIndex, setOpenIndex] = useState<number | null>(mediaIndex !== -1 ? mediaIndex : null);
    ...
    return (
      <div className="py-2 px-1 absolute top-full right-0 z-1000 bg-white sm:w-[290px] max-h-[55vh] overflow-y-scroll">
        <ul
          className="space-y-1"
          onClick={(e) => {
            e.stopPropagation();
