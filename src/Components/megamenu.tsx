export default function Megamenu(props: any) {
  ...
  return (
    <div className="absolute left-0 top-full w-full z-[1000] flex flex-col justify-start px-10 py-2 bg-white max-w-[1340px] max-h-[50vh] overflow-y-auto mx-auto shadow-lg hidden group-hover:block">
